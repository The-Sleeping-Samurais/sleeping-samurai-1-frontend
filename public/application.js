...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var uploadActions = __webpack_require__(12);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createUploadMultiPart = function createUploadMultiPart(event) {
	  ...
	  uploadApi.createMulti(data).then(function () {
	...
	var onGetUploads = function onGetUploads(event) {
	  $('.content').empty();
	  uploadApi.getUploads().then(uploadUi.onGetUploadsSuccess).catch(uploadUi.failure);
	};
	...
	var onGetMyUploads = function onGetMyUploads(event) {
	  $('.content').empty();
	  uploadApi.getMyUploads().then(uploadUi.onGetMyUploadsSuccess).catch(uploadUi.failure);
	};

	var onDeleteUpload = function onDeleteUpload(event) {
	  uploadApi.deleteUpload(this.dataset.id).then(function () {
	    onGetMyUploads();
	  }).catch(uploadUi.deleteFailure);
	};

	var openUpdateModal = function openUpdateModal() {
	  var fileName = $(this).attr('data-name');
	  var fileDes = $(this).attr('data-des');
	  var fileTag = $(this).attr('data-tag');
	...
	var onUpdateUpload = function onUpdateUpload(event) {
	  ...
	  event.preventDefault();
	  uploadApi.updateUpload(data, id).then(function () {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getOneUpload = function getOneUpload(data) {
	  return $.ajax({
	...
	var getMyUploads = function getMyUploads() {
	  return $.ajax({
	...
	var deleteUpload = function deleteUpload(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/uploads/' + data,
	    method: 'DELETE',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var browseTemplate = __webpack_require__(15);
	var editableTemplate = __webpack_require__(35);
	var imageTemplate = __webpack_require__(36);

	var onGetUploadsSuccess = function onGetUploadsSuccess(data) {
	  var imageArray = filterDataForImg(data.uploads);
	  var uploadsHtml = browseTemplate({ uploads: data.uploads });
	  $('#vault').append(uploadsHtml);
	  $('#vault').show();
	  var imageHtml = imageTemplate({ uploads: imageArray });
	...
	//   $('.buttons').show()
	// }
	var onGetMyUploadsSuccess = function onGetMyUploadsSuccess(data) {
	  var imageArray = filterDataForImg(data.uploads);
	  var uploadsHtml = editableTemplate({ uploads: data.uploads });
	  $('#vault').append(uploadsHtml);
	  $('#vault').show();
	  var imageHtml = imageTemplate({ uploads: imageArray });
	  $('#image-board').append(imageHtml);
	...
	var deleteFailure = function deleteFailure(data, error) {
	...
	var createFailure = function createFailure(data, error) {
	...
	var updateFailure = function updateFailure(data, error) {
	...
	var filterDataForImg = function filterDataForImg(dataArray) {
	  var filteredData = [];
	  for (var i = 0; i < dataArray.length; i++) {
	    var url = dataArray[i].url;
	    var urlEnd = url.substr(url.length - 3);
	...
	module.exports = {
	  ...
	  onGetMyUploadsSuccess: onGetMyUploadsSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<tr class=\"content\">\n    <td><p class=\"table-data\">"
	    ...
	    + "</p></td>\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.size : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "    <td><a class=\"table-data\" href=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.url : stack1), depth0))
	    + "\" target=\"_blank\">Click Me</a></td>\n    <td><p class=\"table-data\">"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<tr class=\"content\">\n    <td><p class=\"table-data\">"
	    ...
	    + "\" class=\"remove-button btn btn-primary btn-sm\" type=\"submit\">delete</button>\n    <button class=\"update-button btn btn-primary btn-sm\" data-toggle=\"modal\" data-target=\"#editModal\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-name=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "\" data-des=\""
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<div class=\"images col-sm-2\" style=\"background-image:url("
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.url : stack1), depth0))
	    + ")\">\n  <div class=\"overlay\">\n  </div>\n  <!-- <a href=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.url : stack1), depth0))
	    ...
	    + "</h1>\n  <p class=\"hidden-text\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
	    + "</p>\n  <p class=\"hidden-text\">Tag: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.tag : stack1), depth0))
	    + "</p>\n  <p class=\"hidden-text\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.size : stack1), depth0))
	    + " MB</p>\n  <!-- <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"hidden-buttons remove-button btn btn-sm\" type=\"submit\">delete</button>\n  <button class=\"hidden-buttons update-button btn btn-sm\" data-toggle=\"modal\" data-target=\"#editModal\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-name=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "\" data-des=\""
	    ...
	    + "\" data-tag=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.tag : stack1), depth0))
	    + "\" type=\"button\">\n     edit\n  </button> -->\n  <a class=\"table-data\" href=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.url : stack1), depth0))
	    + "\" target=\"_blank\"><button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"hidden-buttons btn btn-sm\" type=\"click\">View here</button></a>\n</div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "1f1f46b1409cd403179bb4045c64a5df.jpg";
